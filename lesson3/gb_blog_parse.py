...
import time
import pymongo
from lesson3.database.database import Database
...
class GbBlogParse:
    ...
    def _get_post_comments(self, url: str, soup: bs4.BeautifulSoup) -> list:
        params = {
...
if __name__ == "__main__":
    ...
    parser = GbBlogParse("https://gb.ru/posts", db_client, 2)
    parser.run()
    print(1)